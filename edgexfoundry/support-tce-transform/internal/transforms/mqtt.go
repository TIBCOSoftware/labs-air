...
func (sender MQTTSender) MQTTSend(logging logger.LoggingClient, msg string) (bool, interface{}) {
	logging.Info("Sending Notification")
	logging.Debug(fmt.Sprintf("Message: [%s]\n", msg))
	...
	logging.Info("Sent data to MQTT Broker")
	logging.Trace("Data exported", "Transport", "MQTT", clients.CorrelationHeader)
