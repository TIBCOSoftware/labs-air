### TIBCO Cloud™ Starters Toolkit - Air App
The Pattern - Air App, containing all core and essential Case Management Features to create more advanced low-code applications based on TIBCO Cloud™ LiveApps.
