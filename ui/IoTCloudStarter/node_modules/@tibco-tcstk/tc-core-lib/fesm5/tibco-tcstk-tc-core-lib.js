import { Injectable, ɵɵdefineInjectable, Component, ViewChild, Input, ɵɵinject, Output, EventEmitter, Pipe, Directive, Inject, NgModule } from '@angular/core';
import { HashLocationStrategy, Location, DOCUMENT, CommonModule } from '@angular/common';
import { __values, __extends, __spread } from 'tslib';
import { BehaviorSubject, of, merge, Observable, combineLatest, concat, defer, fromEvent, throwError, Subject } from 'rxjs';
import { tap, map, catchError, flatMap, distinctUntilChanged, delay, switchMap, mergeMap } from 'rxjs/operators';
import { HttpParams, HttpHeaders, HttpClient, HttpResponse, HttpErrorResponse, HttpClientModule, HTTP_INTERCEPTORS, HttpRequest } from '@angular/common/http';
import { BrowserModule, DomSanitizer } from '@angular/platform-browser';
import { BrowserAnimationsModule } from '@angular/platform-browser/animations';
import { MatPaginator, MatSort, MatSnackBar, MatDialogRef, MAT_DIALOG_DATA, MatDialog, MatButtonModule, MatCardModule, MatCheckboxModule, MatListModule, MatFormFieldModule, MatInputModule, MatIconModule, MatSelectModule, MatOptionModule, MatDialogModule, MatMenuModule, MatTooltipModule, MatTabsModule, MatExpansionModule, MatToolbarModule, MatButtonToggleModule, MatSortModule, MatTableModule, MatPaginatorModule, MatIconRegistry } from '@angular/material';
...
var MessageTopicService = /** @class */ (function () {
    ...
    /** @nocollapse */ MessageTopicService.ngInjectableDef = ɵɵdefineInjectable({ factory: function MessageTopicService_Factory() { return new MessageTopicService(); }, token: MessageTopicService, providedIn: "root" });
...
var TcLoginService = /** @class */ (function () {
    ...
    /** @nocollapse */ TcLoginService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcLoginService_Factory() { return new TcLoginService(ɵɵinject(HttpClient), ɵɵinject(Location)); }, token: TcLoginService, providedIn: "root" });
...
var TcSharedStateService = /** @class */ (function () {
    ...
    /** @nocollapse */ TcSharedStateService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcSharedStateService_Factory() { return new TcSharedStateService(ɵɵinject(HttpClient), ɵɵinject(Location)); }, token: TcSharedStateService, providedIn: "root" });
...
var RequestCacheService = /** @class */ (function () {
    ...
    /** @nocollapse */ RequestCacheService.ngInjectableDef = ɵɵdefineInjectable({ factory: function RequestCacheService_Factory() { return new RequestCacheService(); }, token: RequestCacheService, providedIn: "root" });
...
var TibcoCloudWidgetHeaderComponent = /** @class */ (function () {
    function TibcoCloudWidgetHeaderComponent() {
         ...
         */
        this.toolbarButtonEvent = new EventEmitter();
    }
    /**
     * @param {?} id
     * @return {?}
    ...
    TibcoCloudWidgetHeaderComponent.propDecorators = {
        ...
        toolbarButtonEvent: [{ type: Output }]
    };
...
var TcButtonsHelperService = /** @class */ (function () {
    ...
    /** @nocollapse */ TcButtonsHelperService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcButtonsHelperService_Factory() { return new TcButtonsHelperService(); }, token: TcButtonsHelperService, providedIn: "root" });
...
var OnCreateDirective = /** @class */ (function () {
    function OnCreateDirective() {
        this.fireCreated = new EventEmitter();
    }
    /**
     * @return {?}
     */
...
var TcGeneralConfigService = /** @class */ (function () {
    ...
    /** @nocollapse */ TcGeneralConfigService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcGeneralConfigService_Factory() { return new TcGeneralConfigService(ɵɵinject(Location), ɵɵinject(TcSharedStateService)); }, token: TcGeneralConfigService, providedIn: "root" });
...
TibcoCloudTableDataSource = /** @class */ (function (_super) {
    ...
    function () {
        ...
        return merge.apply(void 0, __spread(dataMutations)).pipe(map((/**
         * @return {?}
         */
        function () {
...
var TibcoCloudSplashScreenComponent = /** @class */ (function () {
    ...
    function TibcoCloudSplashScreenComponent() {
         ...
         */
        this.topMargin = this.topMargin ? this.topMargin : '0px';
        /**
         ...
         */
        function (route) {
            _this.getStartedEvent.emit(new RouteAction('buttonClicked', route));
        });
    }
    /**
     * @ignore
...
var ActionButtonConfig = /** @class */ (function () {
...
var TcGeneralLandingPageConfigService = /** @class */ (function () {
    ...
    /** @nocollapse */ TcGeneralLandingPageConfigService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcGeneralLandingPageConfigService_Factory() { return new TcGeneralLandingPageConfigService(ɵɵinject(TcSharedStateService)); }, token: TcGeneralLandingPageConfigService, providedIn: "root" });
...
var TibcoCloudNewElementComponent = /** @class */ (function () {
     ...
     * @return {?}
     */
    TibcoCloudNewElementComponent.prototype.onCancel = /**
     * @return {?}
     */
    function () {
...
var LegacyIframeService = /** @class */ (function () {
    ...
    /** @nocollapse */ LegacyIframeService.ngInjectableDef = ɵɵdefineInjectable({ factory: function LegacyIframeService_Factory() { return new LegacyIframeService(); }, token: LegacyIframeService, providedIn: "root" });
...
var TcCoreLibModule = /** @class */ (function () {
    function TcCoreLibModule(matIconRegistry, domSanitizer, location, router, messageService, legacyIFrameService) {
        var _this = this;
...
var TcGeneralLandingPageService = /** @class */ (function () {
    ...
    /** @nocollapse */ TcGeneralLandingPageService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcGeneralLandingPageService_Factory() { return new TcGeneralLandingPageService(ɵɵinject(TcGeneralLandingPageConfigService)); }, token: TcGeneralLandingPageService, providedIn: "root" });
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
var DeserializableClass = /** @class */ (function () {
    function DeserializableClass() {
    }
    /**
     * @template THIS
     * @this {THIS}
     ...
     * @return {THIS}
     */
    DeserializableClass.prototype.deserialize = /**
     * @template THIS
     * @this {THIS}
     * @param {?} input
     * @return {THIS}
...
var TcComponent = /** @class */ (function () {
    ...
    Object.defineProperty(TcComponent.prototype, "xs", {
        /*
      xs	'(max-width: 599px)'
    ...
    Object.defineProperty(TcComponent.prototype, "sm", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(TcComponent.prototype, "lg", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(TcComponent.prototype, "xl", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(TcComponent.prototype, "ltSm", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(TcComponent.prototype, "ltMd", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(TcComponent.prototype, "ltLg", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(TcComponent.prototype, "ltXl", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(TcComponent.prototype, "gtXs", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(TcComponent.prototype, "gtSm", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(TcComponent.prototype, "gtMd", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(TcComponent.prototype, "gtLg", {
        get: /**
         * @return {?}
         */
        function () {
     ...
     * @return {THIS}
     */
    TcComponent.prototype.deserialize = /**
     * @template THIS
     * @this {THIS}
     * @param {?} input
     * @return {THIS}
...
/** @type {?} */
var DEFAULT_ADMIN_GROUP = new RoleAttribute().deserialize({
    id: 'Administrator',
...
var ConfigurationMenuConfigResolver = /** @class */ (function () {
    ...
    function (routeSnapshot) {
        var _this = this;
        /** @type {?} */
        var configurationMenuConfig$ = this.getAppId().pipe(flatMap((/**
         * @param {?} uiAppId
         * @return {?}
         */
        function (uiAppId) {
            return _this.getConfigurationMenuConfig(uiAppId.uiAppId).pipe(map((/**
             * @param {?} config
             * @return {?}
             */
            function (config) {
...
var MessageQueueService = /** @class */ (function () {
    ...
    /** @nocollapse */ MessageQueueService.ngInjectableDef = ɵɵdefineInjectable({ factory: function MessageQueueService_Factory() { return new MessageQueueService(); }, token: MessageQueueService, providedIn: "root" });
    return MessageQueueService;
}());

export { AccessToken, AccountInfo, AccountsInfo, ActionButtonConfig, AuthGuard, AuthInfo, CLIENT_ID_KEY, CachingInterceptor, Claim, ConfigurationMenuConfig, ConfigurationMenuConfigResolver, ConfigurationMenuEntry, DEFAULT_ADMIN_GROUP, DeserializableClass, DurationSincePipe, EMAIL_ID_KEY, EllipsisPipe, GeneralConfig, GeneralConfigResolver, GeneralLandingPageConfig, GeneralLandingPageConfigResolver, Group, HighlightPipe, LandingPageConfig, LandingPageItemConfig, LegacyIframeService, LogLevel, LogService, LoginPrefill, LoginPrefillResolver, MessageQueueService, MessageTopicService, MockingInterceptor, OnCreateDirective, OrderByDatePipe, Owner, RequestCacheService, ReversePipe, RoleAttribute, RouteAction, Sandbox, SandboxList, SharedStateContent, SharedStateEntry, SharedStateList, Subscription, TcButtonsHelperService, TcComponent, TcCoreCommonFunctions, TcCoreLibModule, TcGeneralConfigService, TcGeneralLandingPageConfigService, TcGeneralLandingPageService, TcLoginService, TcSharedStateService, TcVisibilityService, TibcoCloudConfigurationComponent, TibcoCloudErrorComponent, TibcoCloudLoginComponent, TibcoCloudMenuBarComponent, TibcoCloudNavbarComponent, TibcoCloudNewElementComponent, TibcoCloudSelectTableComponent, TibcoCloudSettingLandingComponent, TibcoCloudSettingMenuEntryComponent, TibcoCloudSettingsGeneralComponent, TibcoCloudSplashScreenComponent, TibcoCloudTableComponent, TibcoCloudUploadDialogComponent, TibcoCloudWidgetHeaderComponent, ToolbarButton, UiAppConfig, UiAppIdConfig, AuthErrorInterceptor as ɵa };
//# sourceMappingURL=tibco-tcstk-tc-core-lib.js.map
