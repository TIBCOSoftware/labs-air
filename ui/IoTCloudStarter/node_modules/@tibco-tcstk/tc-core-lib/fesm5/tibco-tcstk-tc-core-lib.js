...
import { HashLocationStrategy, Location, CommonModule } from '@angular/common';
import { __values, __extends, __spread } from 'tslib';
import { BehaviorSubject, of, merge, throwError, Subject } from 'rxjs';
import { tap, map, catchError, delay, switchMap, mergeMap, flatMap } from 'rxjs/operators';
...
var TcCoreLibModule = /** @class */ (function () {
    function TcCoreLibModule(matIconRegistry, domSanitizer, location, router, messageService) {
        var _this = this;
...
export { AccessToken, AccountInfo, AccountsInfo, AuthGuard, AuthInfo, CLIENT_ID_KEY, CachingInterceptor, Claim, ConfigurationMenuConfig, ConfigurationMenuConfigResolver, ConfigurationMenuEntry, DurationSincePipe, EMAIL_ID_KEY, EllipsisPipe, GeneralConfig, GeneralConfigResolver, GeneralLandingPageConfig, GeneralLandingPageConfigResolver, Group, HighlightPipe, LandingPageConfig, LandingPageItemConfig, LogLevel, LogService, LoginPrefill, LoginPrefillResolver, MessageQueueService, MessageTopicService, MockingInterceptor, OnCreateDirective, OrderByDatePipe, Owner, RequestCacheService, ReversePipe, RoleAttribute, RouteAction, Sandbox, SandboxList, SharedStateContent, SharedStateEntry, SharedStateList, Subscription, TcButtonsHelperService, TcCoreCommonFunctions, TcCoreLibModule, TcGeneralConfigService, TcGeneralLandingPageConfigService, TcGeneralLandingPageService, TcLoginService, TcSharedStateService, TibcoCloudConfigurationComponent, TibcoCloudErrorComponent, TibcoCloudLoginComponent, TibcoCloudMenuBarComponent, TibcoCloudNavbarComponent, TibcoCloudNewElementComponent, TibcoCloudSelectTableComponent, TibcoCloudSettingLandingComponent, TibcoCloudSettingMenuEntryComponent, TibcoCloudSettingsGeneralComponent, TibcoCloudSplashScreenComponent, TibcoCloudTableComponent, TibcoCloudWidgetHeaderComponent, ToolbarButton, UiAppConfig, UiAppIdConfig, AuthErrorInterceptor as ɵa };
