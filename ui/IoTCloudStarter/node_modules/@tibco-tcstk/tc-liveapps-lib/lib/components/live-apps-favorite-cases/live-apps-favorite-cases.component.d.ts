 ...
 */
export declare class LiveAppsFavoriteCasesComponent extends LiveAppsComponent implements OnInit, AfterViewInit {
    ...
    refresh: () => void;
    clearFavoriteCases: () => void;
    handleDeleted: (caseRef: string) => void;
