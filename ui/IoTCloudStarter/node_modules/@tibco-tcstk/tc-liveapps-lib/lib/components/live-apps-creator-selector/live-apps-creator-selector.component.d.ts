...
export declare class LiveAppsCreatorSelectorComponent extends LiveAppsComponent implements OnChanges {
    private liveapps;
    creatorSelector: MatSelect;
    sandboxId: number;
    appId: string;
    typeId: string;
    /**
     ...
     */
    creatorSelection: EventEmitter<LaProcessSelection>;
