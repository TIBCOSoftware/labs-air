 ...
 */
export declare class LiveAppsSettingsSummaryCardsComponent extends LiveAppsSettingsComponent {
    protected caseCardConfigService: TcCaseCardConfigService;
    protected routeExt: ActivatedRoute;
    protected liveAppsConfigServiceExt: TcLiveAppsConfigService;
    ...
    handleConfigChanged: (caseCardConfig: CaseCardConfig) => void;
    handleAppSelection: (application: CaseType) => void;
    runSaveFunction: () => void;
}
