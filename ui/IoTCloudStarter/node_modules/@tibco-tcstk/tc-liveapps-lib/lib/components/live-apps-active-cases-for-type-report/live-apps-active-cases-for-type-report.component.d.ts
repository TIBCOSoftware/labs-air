import { AfterViewChecked, ElementRef, EventEmitter, OnChanges, OnInit, SimpleChanges } from '@angular/core';
 ...
 */
export declare class LiveAppsActiveCasesForTypeReportComponent extends LiveAppsComponent implements OnInit, OnChanges, AfterViewChecked {
    protected reportingService: TcLiveAppsReportingService;
    /**
    ...
    caseTypeStateReportChart: BaseChartDirective;
