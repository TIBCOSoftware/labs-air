...
export declare class AllRolesResolver implements Resolve<Observable<Roles>> {
    private sharedStateService;
    private generalConfigService;
    private http;
    private liveapps;
    private location;
    constructor(sharedStateService: TcSharedStateService, generalConfigService: TcGeneralConfigService, http: HttpClient, liveapps: LiveAppsService, location: Location);
