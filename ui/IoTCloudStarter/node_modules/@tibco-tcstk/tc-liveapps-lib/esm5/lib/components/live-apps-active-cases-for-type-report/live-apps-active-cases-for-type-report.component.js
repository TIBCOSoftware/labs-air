...
var LiveAppsActiveCasesForTypeReportComponent = /** @class */ (function (_super) {
    ...
    function LiveAppsActiveCasesForTypeReportComponent(reportingService) {
         ...
         */
        function () {
            _this.reportingService.getCaseTypeStateReport(_this.sandboxId, _this.appId, _this.typeId, false, _this.uiAppId).pipe(take(1), takeUntil(_this._destroyed$))
                .subscribe((/**
             * @param {?} report
             * @return {?}
             */
