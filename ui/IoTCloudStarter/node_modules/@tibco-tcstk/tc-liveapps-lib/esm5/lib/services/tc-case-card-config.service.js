...
/** @type {?} */
export var DEFAULT_TYPE_COLOR = '#8197c0';
/** @type {?} */
export var DEFAULT_STATE_COLOR = '#8197c0';
/** @type {?} */
export var GENERIC_STATE_ICON_SVG = '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14">\n' +
    ...
    '</svg>\n';
/** @type {?} */
export var GENERIC_CASETYPE_ICON_SVG = '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 48 48">\n' +
...
var TcCaseCardConfigService = /** @class */ (function () {
    ...
    function (states, sandboxId, appId, uiAppId, caseTypeId, defaultCaseTypeColor, defaultCaseTypeIcon, defaultStateColor, defaultStateIcon) {
        ...
        /** @type {?} */
        var updatedConfig$ = newConfig$.pipe(mergeMap((/**
         * @param {?} id
         * @return {?}
         */
        function (id) {
            ...
            return _this.updateCardConfig(sandboxId, appId, uiAppId, newCardConfig, id).pipe(tap((/**
             * @param {?} config
             * @return {?}
             */
            function (config) {
    ...
    function (sandboxId, appId, uiAppId, caseTypeId, defaultCaseTypeColor, defaultCaseTypeIcon, defaultStateColor, defaultStateIcon) {
        ...
        /** @type {?} */
        var cardConfig$ = this.getCardConfig(uiAppId, appId, true, false).pipe(map((/**
         * @param {?} config
         * @return {?}
         */
        function (config) {
        ...
        function (states) {
            ...
            function (config) {
                if (config) {
                    ...
                    return _this.createNewCardConfig(states.states, sandboxId, appId, uiAppId, caseTypeId, defaultCaseTypeColor, defaultCaseTypeIcon, defaultStateColor, defaultStateIcon).pipe(map((/**
                     * @param {?} newCardConfig
                     * @return {?}
                     */
    ...
    function (caseinfo, sandboxId, appId, typeId, uiAppId) {
        ...
        /** @type {?} */
        var caseInfo$ = this.liveAppsService.getCaseTypeBasicInfo(sandboxId, appId, typeId, 100).pipe(map((/**
         * @param {?} val
         * @return {?}
         */
...
export { TcCaseCardConfigService };
if (false) {
    /**
     * @type {?}
     * @private
