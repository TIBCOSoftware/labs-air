    ...
    ***************************************************************************** */
    ...
    var LiveAppsCaseStatesComponent = /** @class */ (function (_super) {
        ...
        function LiveAppsCaseStatesComponent(caseStatesService, durationSince) {
             ...
             */
            function () {
                _this.caseStatesService.getTracker(_this.caseRef, _this.sandboxId, _this.appId).pipe(operators.take(1), operators.takeUntil(_this._destroyed$), operators.map((/**
                 * @param {?} tracker
                 * @return {?}
                 */
                function (tracker) {
    ...
    var LiveAppsApplicationConfigurationComponent = /** @class */ (function (_super) {
        ...
        function LiveAppsApplicationConfigurationComponent(http, sanitizer, liveapps, caseCardConfigService, documentsService, dialog, location) {
            ...
            function () {
                ...
                _this.caseCardConfigService.getCaseCardConfig(_this.sandboxId, _this.appId, _this.uiAppId, _this.appTypeLabel, _this.DEFAULT_CASE_TYPE_COLOR, _this.DEFAULT_CASE_TYPE_ICON, _this.DEFAULT_CASE_STATE_COLOR, _this.DEFAULT_CASE_STATE_ICON).pipe(operators.take(1), operators.takeUntil(_this._destroyed$), operators.map((/**
    ...
    var LiveAppsCreatorSelectorComponent = /** @class */ (function (_super) {
        ...
        function LiveAppsCreatorSelectorComponent(liveapps) {
            ...
            function () {
                ...
                _this.liveapps.getCaseTypeSchema(_this.sandboxId, _this.appId, 100).pipe(operators.map((/**
                 * @param {?} schema
                 * @return {?}
                 */
                function (schema) {
        ...
        function () {
            ...
            if (this.incFavButton) {
                this.liveapps.isFavoriteCase(this.caseRef, this.uiAppId, this.sandboxId)
                    .pipe(operators.take(1), operators.takeUntil(this._destroyed$), operators.map((/**
                 * @param {?} result
                 * @return {?}
                 */
                function (result) {
    ...
    var LiveAppsActiveCasesReportComponent = /** @class */ (function (_super) {
        ...
        function LiveAppsActiveCasesReportComponent(reportingService) {
             ...
             */
            function () {
                _this.reportingService.getCaseTypesReport(_this.sandboxId, _this.appIds, _this.uiAppId).pipe(operators.take(1), operators.takeUntil(_this._destroyed$), operators.map((/**
                 * @param {?} report
                 * @return {?}
                 */
                function (report) {
    ...
    var LiveAppsActiveCasesForTypeReportComponent = /** @class */ (function (_super) {
        ...
        function LiveAppsActiveCasesForTypeReportComponent(reportingService) {
             ...
             */
            function () {
                _this.reportingService.getCaseTypeStateReport(_this.sandboxId, _this.appId, _this.typeId, false, _this.uiAppId).pipe(operators.take(1), operators.takeUntil(_this._destroyed$), operators.map((/**
                 * @param {?} report
                 * @return {?}
                 */
                function (report) {
    ...
    var LiveAppsLandingPageComponent = /** @class */ (function () {
        ...
        function () {
            ...
            this.landingPageService.getLandingPageForRole(roleId, uiAppId).pipe(operators.map((/**
             * @param {?} landingPage
             * @return {?}
             */
            function (landingPage) {
                if (landingPage != undefined) {
                    ...
                    _this.backgroundImage = (landingPage.backgroundURL != '' ? tcCoreLib.TcCoreCommonFunctions.prepareUrlForStaticResource(_this.location, landingPage.backgroundURL) : '');
    ...
    var RolesResolver = /** @class */ (function () {
        ...
        function () {
            ...
            /** @type {?} */
            var generalConfigResolver = new tcCoreLib.GeneralConfigResolver(this.sharedStateService, this.generalConfigService, this.http, this.location);
    ...
    var RoleGuard = /** @class */ (function () {
        function RoleGuard(liveapps, router, http$1, location, sharedStateService, generalConfigService) {
            var _this = this;
            this.liveapps = liveapps;
            this.router = router;
            this.http = http$1;
            ...
            function () {
                /** @type {?} */
                var headers = new http.HttpHeaders().set('cacheResponse', 'true');
                return _this.http.get(_this.DEFAULT_CONFIG_URL, { headers: headers }).pipe(operators.map((/**
        ...
        function (route, state) {
            ...
            /** @type {?} */
            var decision$ = rxjs.forkJoin(routeConfig$, currentRoles$).pipe(operators.map((/**
             * @param {?} __0
             * @return {?}
             */
            function (_a) {
    ...
    var AccessResolver = /** @class */ (function () {
        ...
        function () {
            /** @type {?} */
            var headers = new http.HttpHeaders().set('cacheResponse', 'true');
            return this.http.get(tcCoreLib.TcCoreCommonFunctions.prepareUrlForStaticResource(this.location, this.ACCESS_CONTROL_CONFIG_URL), { headers: headers }).pipe(operators.map((/**
             * @param {?} accessControl
             * @return {?}
             */
    ...
    var RoleActiveResolver = /** @class */ (function () {
        ...
        function () {
            ...
            if (currentRole == undefined) {
                /** @type {?} */
                var generalConfigResolver_1 = new tcCoreLib.GeneralConfigResolver(this.tcSharedStateService, this.generalConfigService, this.httpClient, this.location);
                /** @type {?} */
                var claimResolver$ = new ClaimsResolver(this.liveAppsService);
                return claimResolver$.resolve().pipe(operators.flatMap((/**
                 * @param {?} claim
                 * @return {?}
                 */
                function (claim) {
                    ...
                    return generalConfigResolver_1.resolve().pipe(operators.map((/**
                     * @param {?} generalConfig
                     * @return {?}
                     */
                    function (generalConfig) {
    ...
    exports.ButtonAccessDef = ButtonAccessDef;
    ...
    exports.RouteAccessDef = RouteAccessDef;
    ...
    exports.ɵe = LiveAppsActiveCasesForTypeReportComponent;
