...
import { SandboxList, Claim, SharedStateContent, TcCoreCommonFunctions, TcSharedStateService, SharedStateEntry, SharedStateList, TcButtonsHelperService, DurationSincePipe, RouteAction, TibcoCloudNewElementComponent, RoleAttribute, TcGeneralConfigService, TibcoCloudSettingsGeneralComponent, LandingPageItemConfig, TcGeneralLandingPageService, GeneralConfigResolver, TcCoreLibModule, RequestCacheService, CachingInterceptor, UiAppIdConfig } from '@tibco-tcstk/tc-core-lib';
...
var RouteAccessDef = /** @class */ (function () {
    function RouteAccessDef() {
    }
    return RouteAccessDef;
}());
var ButtonAccessDef = /** @class */ (function () {
    function ButtonAccessDef() {
    }
    return ButtonAccessDef;
}());
...
var LiveAppsCaseSummaryComponent = /** @class */ (function (_super) {
    ...
    function LiveAppsCaseSummaryComponent(liveapps, caseCardConfigService, sanitizer) {
        ...
        function () {
            /** @type {?} */
            var caseRoute = new CaseRoute().deserialize({ caseRef: _this.caseRef, appId: _this.appId, typeId: _this.typeId });
            _this.clickCase.emit(caseRoute);
        });
...
var LiveAppsCaseDataDisplayComponent = /** @class */ (function () {
    function LiveAppsCaseDataDisplayComponent() {
...
var TcRolesService = /** @class */ (function () {
    function TcRolesService() {
         ...
         * @return {?}
         */
        function (buttonId, roles, access) {
            // check which role required
            /** @type {?} */
            var reqRole = access.buttons.find((/**
             * @param {?} buttonRec
             * @return {?}
             */
            function (buttonRec) {
...
var CaseCreatorSelectionContext = /** @class */ (function () {
    function CaseCreatorSelectionContext(application, initialData, sandboxId, customFormDefs) {
...
var TcLiveAppsReportingService = /** @class */ (function () {
    ...
    function (report, uiAppId) {
         ...
         */
        function (caseType) {
            caseStateColorMaps$.push(_this.caseConfigService.getStateColorInfo(caseType.applicationId, uiAppId).pipe(map((/**
             * @param {?} stateColMap
             * @return {?}
             */
    ...
    function (sandboxId, appIds, uiAppId) {
         ...
         * @return {?}
         */
        function (val) { return sessionStorage.setItem('tcsTimestamp', Date.now().toString()); })), flatMap((/**
         * @param {?} response
         * @return {?}
         */
        function (response) {
...
var LiveAppsHomeCockpitComponent = /** @class */ (function () {
    function LiveAppsHomeCockpitComponent(buttonsHelper, dialog, rolesService) {
        ...
        function (caseRoute) {
            ...
            _this.routeAction.emit(new RouteAction('caseClicked', caseRoute));
        });
        this.createToolbarButtons = (/**
         * @return {?}
         */
        ...
        function (application) {
            ...
            _this.openCreatorDialog(application, undefined, _this.sandboxId, _this.customFormDefs);
        });
         ...
         * @return {?}
         */
        function (application, initialData, sandboxId, customFormDefs) {
            /** @type {?} */
            ...
            function (result) {
                if (result) {
                    _this.routeAction.emit(new RouteAction('caseClicked', result));
                }
            }));
        });
        this.refresh = (/**
     ...
     * @return {?}
     */
    LiveAppsHomeCockpitComponent.prototype.ngOnInit = /**
     * @return {?}
     */
    function () {
        this.toolbarButtons = this.toolbarButtons.concat(this.createToolbarButtons());
...
var RoleGuard = /** @class */ (function () {
    ...
    function (route, state) {
         ...
         */
        function (_a) {
            var _b = __read(_a, 2), routeConfig = _b[0], currentRoles = _b[1];
            /** @type {?} */
