import { Injectable, ɵɵdefineInjectable, ɵɵinject, Component, EventEmitter, Input, Output, ViewChild, Inject, ViewChildren, ContentChildren, Pipe, NgModule } from '@angular/core';
import { HttpHeaders, HttpClient, HttpEventType, HttpClientModule, HTTP_INTERCEPTORS } from '@angular/common/http';
import { MatDialog, MatDialogRef, MAT_DIALOG_DATA, MatSelectionList, MatSnackBar, MatButtonModule, MatCardModule, MatCheckboxModule, MatListModule, MatFormFieldModule, MatInputModule, MatIconModule, MatSelectModule, MatOptionModule, MatDialogModule, MatMenuModule, MatTooltipModule, MatTabsModule, MatToolbarModule, MatExpansionModule, MatSnackBarModule, MatSlideToggleModule, MatProgressBarModule, MatIconRegistry } from '@angular/material';
...
import { SandboxList, Claim, SharedStateContent, TcCoreCommonFunctions, TcSharedStateService, SharedStateEntry, SharedStateList, TcButtonsHelperService, DurationSincePipe, RouteAction, TibcoCloudSettingsGeneralComponent, TibcoCloudNewElementComponent, RoleAttribute, TcGeneralConfigService, LandingPageItemConfig, TcGeneralLandingPageService, GeneralConfigResolver, TcCoreLibModule, RequestCacheService, CachingInterceptor, UiAppIdConfig } from '@tibco-tcstk/tc-core-lib';
import { Subject, of, forkJoin, throwError, zip } from 'rxjs';
import { tap, map, debounceTime, distinctUntilChanged, switchMap, shareReplay, take, takeUntil, mergeMap, catchError, flatMap } from 'rxjs/operators';
...
class RouteAccessDef {
}
class ButtonAccessDef {
}
class RouteAccessControlConfig {
    /**
     * @template THIS
     * @this {THIS}
     * @param {?} input
...
/** @nocollapse */ LiveAppsService.ngInjectableDef = ɵɵdefineInjectable({ factory: function LiveAppsService_Factory() { return new LiveAppsService(ɵɵinject(HttpClient), ɵɵinject(Location), ɵɵinject(TcSharedStateService)); }, token: LiveAppsService, providedIn: "root" });
 ...
 */
class LiveAppsApplicationsComponent extends LiveAppsComponent {
    /**
     * @param {?} liveapps
     */
 ...
 */
class LiveAppsCaseSearchComponent extends LiveAppsComponent {
    /**
     * @param {?} liveapps
     */
    constructor(liveapps) {
 ...
 */
class LiveAppsCaseListComponent extends LiveAppsComponent {
    /**
     * @param {?} liveapps
     */
    constructor(liveapps) {
...
/** @type {?} */
const DEFAULT_TYPE_COLOR = '#8197c0';
/** @type {?} */
const DEFAULT_STATE_COLOR = '#8197c0';
/** @type {?} */
const GENERIC_STATE_ICON_SVG = '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14">\n' +
    ...
    '</svg>\n';
/** @type {?} */
const GENERIC_CASETYPE_ICON_SVG = '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 48 48">\n' +
...
/** @nocollapse */ TcCaseCardConfigService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcCaseCardConfigService_Factory() { return new TcCaseCardConfigService(ɵɵinject(HttpClient), ɵɵinject(LiveAppsService), ɵɵinject(TcSharedStateService), ɵɵinject(Location)); }, token: TcCaseCardConfigService, providedIn: "root" });
 ...
 */
class LiveAppsStateIconComponent extends LiveAppsComponent {
    /**
     * @param {?} sanitizer
     * @param {?} http
     * @param {?} liveapps
 ...
 */
class LiveAppsCaseSummaryComponent extends LiveAppsComponent {
    /**
     * @param {?} liveapps
     * @param {?} caseCardConfigService
     * @param {?} sanitizer
     */
    constructor(liveapps, caseCardConfigService, sanitizer) {
        super();
        this.liveapps = liveapps;
 ...
 */
class LiveAppsNotesComponent extends LiveAppsComponent {
    /**
     * @param {?} liveapps
     * @param {?} buttonsHelper
     */
...
/** @nocollapse */ TcDocumentService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcDocumentService_Factory() { return new TcDocumentService(ɵɵinject(HttpClient), ɵɵinject(LiveAppsService)); }, token: TcDocumentService, providedIn: "root" });
 ...
 */
class LiveAppsDocumentsComponent extends LiveAppsComponent {
    /**
     * @param {?} liveapps
...
class LiveAppsDocumentUploadDialogComponent {
    /**
     * @param {?} dialogRef
     */
...
class LiveAppsDocumentViewerDialogComponent {
    /**
     * @param {?} dialogRef
     * @param {?} data
     */
...
/** @nocollapse */ TcCaseDataService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcCaseDataService_Factory() { return new TcCaseDataService(ɵɵinject(HttpClient), ɵɵinject(LiveAppsService), ɵɵinject(TcCaseCardConfigService)); }, token: TcCaseDataService, providedIn: "root" });

/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class StateAuditEventList {
    /**
     * @template THIS
     * @this {THIS}
     * @param {?} input
...
/** @nocollapse */ TcCaseStatesService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcCaseStatesService_Factory() { return new TcCaseStatesService(ɵɵinject(HttpClient), ɵɵinject(LiveAppsService), ɵɵinject(TcCaseDataService), ɵɵinject(DomSanitizer), ɵɵinject(Location)); }, token: TcCaseStatesService, providedIn: "root" });
 ...
 */
class LiveAppsCaseStatesComponent extends LiveAppsComponent {
    /**
 ...
 */
class LiveAppsApplicationConfigurationComponent extends LiveAppsComponent {
    /**
     * @param {?} http
     * @param {?} sanitizer
     * @param {?} liveapps
...
class LiveAppsStateIconUploadDialogComponent {
    /**
     * @param {?} dialogRef
     * @param {?} data
     */
 ...
 */
class LiveAppsFavoriteCasesComponent extends LiveAppsComponent {
    /**
     * @param {?} liveapps
     */
    constructor(liveapps) {
...
/** @nocollapse */ TcCaseAuditService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcCaseAuditService_Factory() { return new TcCaseAuditService(ɵɵinject(HttpClient)); }, token: TcCaseAuditService, providedIn: "root" });
 ...
 */
class LiveAppsCaseAuditComponent extends LiveAppsComponent {
    /**
 ...
 */
class LiveAppsCaseDataComponent extends LiveAppsComponent {
    /**
     * @param {?} caseDataService
     */
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class LaProcessSelection {
    // Format of ref is <applicationName>.<applicationInternalName>.<processType>.<processName>
    /**
     * @param {?} type
     * @param {?} appSchema
     * @param {?} caseIdAttribute
     * @param {?} process
     * @param {?} ref
     * @param {?} caseReference
     */
    constructor(type, appSchema, caseIdAttribute, process, ref, caseReference) {
        this.type = type;
...
/** @nocollapse */ TcCaseProcessesService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcCaseProcessesService_Factory() { return new TcCaseProcessesService(ɵɵinject(HttpClient), ɵɵinject(LiveAppsService), ɵɵinject(TcCaseDataService)); }, token: TcCaseProcessesService, providedIn: "root" });
 ...
 */
class LiveAppsCaseActionsComponent extends LiveAppsComponent {
    /**
     * @param {?} liveapps
 ...
 */
class LiveAppsRecentCasesComponent extends LiveAppsComponent {
    /**
     * @param {?} liveapps
     */
    constructor(liveapps) {
 ...
 */
class LiveAppsCaseStateAuditComponent extends LiveAppsComponent {
    /**
     * @param {?} caseStatesService
     */
 ...
 */
class LiveAppsNotesEditorComponent extends LiveAppsComponent {
 ...
 */
class LiveAppsLoginComponent extends LiveAppsComponent {
    constructor() {
        super();
 ...
 */
class LiveAppsSearchWidgetComponent extends LiveAppsComponent {
    /**
     * @param {?} liveapps
     */
    constructor(liveapps) {
 ...
 */
class LiveAppsCaseCreatorComponent extends LiveAppsComponent {
    /**
     * @param {?} liveapps
     */
    constructor(liveapps) {
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class LiveAppsCreatorSelectorComponent extends LiveAppsComponent {
    /**
     * @param {?} liveapps
     */
    constructor(liveapps) {
 ...
 */
class LiveAppsCreatorsComponent {
    constructor() {
        /**
 ...
 */
class LiveAppsCaseActionComponent extends LiveAppsCaseCreatorComponent {
    /**
     * @param {?} lasvc
     */
    constructor(lasvc) {
 ...
 */
class LiveAppsActionsComponent {
    constructor() {
        /**
 ...
 */
class LiveAppsCaseDataDisplayComponent {
    constructor() {
...
/** @nocollapse */ TcRolesService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcRolesService_Factory() { return new TcRolesService(); }, token: TcRolesService, providedIn: "root" });
 ...
 */
class LiveAppsCaseCockpitComponent {
    /**
     * @param {?} liveapps
     * @param {?} buttonsHelper
     * @param {?} router
 ...
 */
class LiveAppsMilestoneComponent {
    /**
     * @param {?} caseStatesService
     */
    constructor(caseStatesService) {
 ...
 */
class LiveAppsAppConfigurationWidgetComponent {
    constructor() {
        /**
         * ~event configChanged : Configuration values changed
         * ~payload CaseCardConfig : CaseCardConfig object when configuration is changed (so called can do a save with data)
 ...
 */
class LiveAppsCaseCreatorWidgetComponent {
    constructor() {
        /**
         * ~event caseCreated : Case Creator started (process started)
         * ~payload ProcessId : ProcessId object output on case creation (details of process started)
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class CaseCreatorSelectionContext {
    /**
     * @param {?} application
     * @param {?} initialData
     * @param {?} sandboxId
     ...
     */
    constructor(application, initialData, sandboxId, customFormDefs) {
 ...
 */
class LiveAppsCreatorDialogComponent {
    /**
     * @param {?} dialogRef
     * @param {?} data
     */
...
LiveAppsCreatorDialogComponent.decorators = [
    { type: Component, args: [{
                ...
                styles: [".tcs-dialog-outer-div{height:100%;display:-webkit-box;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;flex-direction:column}.tcs-spacer{-webkit-box-flex:1;flex-grow:1}.tcs-case-creation-dialog-toolbar{padding-left:20px;padding-right:20px;background-color:#fff;border-bottom:1px solid #dcdcdc}.tcs-case-creation-dialog-toolbar-text{font-family:Source Sans Pro;font-size:18px;font-weight:600;font-style:normal;font-stretch:normal;line-height:1.5;letter-spacing:.3px}.tcs-case-creation-dialog-details{padding:20px}.tcs-case-created-confirmation-text{font-family:Source Sans Pro;font-size:16px;font-weight:400;font-style:normal;font-stretch:normal;line-height:normal;letter-spacing:normal;color:#b6b6b6}.tcs-case-creation-dialog-actions{padding:20px}:host ::ng-deep .tcs-dialog-actions.mat-dialog-actions{margin-bottom:0;padding:20px}.tcs-case-creation-dialog.mat-dialog-content{padding:0;margin:0}.tcs-case-created-confirmation-details{margin-top:20px}.tcs-case-creation-dialog-icons{height:16px;width:16px}.tcs-case-creation-dialog-icons:hover{cursor:pointer}:host ::ng-deep .tcs-case-creation-dialog-icons:hover .svg-content{fill:#0081cb}"]
            }] }
];
/** @nocollapse */
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class CaseTypeReportRecordInfo {
    /**
     * @template THIS
     * @this {THIS}
     * @param {?} input
...
class CaseTypeStateReportStateInfo {
    /**
     * @template THIS
     * @this {THIS}
     * @param {?} input
...
class CaseTypeStateReportRecord {
    /**
     * @template THIS
     * @this {THIS}
     * @param {?} input
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class TcLiveAppsReportingService {
    /**
     * @param {?} http
...
/** @nocollapse */ TcLiveAppsReportingService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcLiveAppsReportingService_Factory() { return new TcLiveAppsReportingService(ɵɵinject(HttpClient), ɵɵinject(TcCaseCardConfigService)); }, token: TcLiveAppsReportingService, providedIn: "root" });
 ...
 */
class LiveAppsActiveCasesReportComponent extends LiveAppsComponent {
    /**
 ...
 */
class LiveAppsActiveCasesForTypeReportComponent extends LiveAppsComponent {
    /**
     * @param {?} reportingService
     */
    constructor(reportingService) {
 ...
 */
class LiveAppsActiveCasesWidgetComponent extends LiveAppsComponent {
    constructor() {
        super(...arguments);
        /**
         * Maximum rows to show in legend before it is hidden (otherwise would take whole widget)
 ...
 */
class LiveAppsHomeCockpitComponent {
    /**
     * @param {?} buttonsHelper
     * @param {?} dialog
     * @param {?} rolesService
...
/** @nocollapse */ TcLiveAppsConfigService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcLiveAppsConfigService_Factory() { return new TcLiveAppsConfigService(ɵɵinject(Location), ɵɵinject(TcSharedStateService)); }, token: TcLiveAppsConfigService, providedIn: "root" });
 ...
 */
class LiveAppsApplicationListComponent extends LiveAppsApplicationsComponent {
    constructor() {
        super(...arguments);
        /**
 ...
 */
class LiveAppsApplicationCreateButtonComponent extends LiveAppsApplicationsComponent {
    constructor() {
        super(...arguments);
        this.handleCreatorAppSelection = (/**
         * @param {?} application
 ...
 */
class LiveAppsSettingsComponent extends LiveAppsComponent {
    /**
     * @param {?} route
 ...
 */
class LiveAppsSettingsSummaryCardsComponent extends LiveAppsSettingsComponent {
    /**
     * @param {?} caseCardConfigService
     * @param {?} routeExt
 ...
 */
class LiveAppsSettingsRecentCasesComponent extends LiveAppsSettingsComponent {
    constructor() {
        super(...arguments);
        this.LIVE_APPS_URL = '/apps/dt-app/index.html#/application-content/';
        this.runSaveFunction = (/**
     ...
     * @return {?}
     */
    handleExcludeRecentAppIdSelection(appIds) {
 ...
 */
class LiveAppsSettingsRolesComponent extends TibcoCloudSettingsGeneralComponent {
    /**
     * @param {?} route
 ...
 */
class LiveAppsRoleSwitcherComponent {
    constructor() {
        /**
 ...
 */
class LiveAppsCaseCreatorsComponent extends LiveAppsComponent {
    /**
     * @param {?} liveapps
     * @param {?} caseProcessesService
     */
 ...
 */
class LiveAppsCaseActionsListComponent extends LiveAppsCaseActionsComponent {
    constructor() {
        super(...arguments);
        this.refresh = (/**
         * @return {?}
 ...
 */
class LiveAppsDocumentViewerComponent {
    /**
     * @param {?} sanitizer
     * @param {?} documentsService
     * @param {?} location
 ...
 */
class LiveAppsLandingPageComponent {
    /**
     * @param {?} location
     * @param {?} route
     * @param {?} router
...
class GroupsResolver {
    ...
    resolve() {
         ...
         */
        claiminfo => {
            return this.liveapps.getGroupMemberships(+claiminfo.primaryProductionSandbox.id, claiminfo.id, 1000, true).pipe(map((/**
             * @param {?} groupinfo
             * @return {?}
             */
            groupinfo => {
...
class RoleActiveResolver {
     ...
     * @param {?} location
     */
    constructor(rolesService, liveAppsService, route, tcSharedStateService, generalConfigService, httpClient, location) {
        this.rolesService = rolesService;
        this.liveAppsService = liveAppsService;
        this.route = route;
    ...
    resolve() {
        ...
        if (currentRole == undefined) {
            ...
            claim => {
                ...
                generalConfigResolver.setSandbox(Number(sandboxId));
                return generalConfigResolver.resolve().pipe(map((/**
                 * @param {?} generalConfig
                 * @return {?}
                 */
                generalConfig => {
                    /** @type {?} */
                    const highestRole = generalConfig.roles.reduce((/**
                     * @param {?} prev
                     * @param {?} current
                     * @return {?}
                     */
...
export { AccessResolver, AllGroupsResolver, AllRolesResolver, ApiResponseError, ApiResponseText, ButtonAccessDef, CardConfig, CaseAction, CaseActionsList, CaseAttribute, CaseCreator, CaseCreatorSelectionContext, CaseCreatorsList, CaseDataResolver, CaseGuard, CaseInfo, CaseInfoList, CaseInfoWithSchema, CaseList, CaseRoute, CaseSearchResults, CaseType, CaseTypeReportRecord, CaseTypeReportRecordInfo, CaseTypeState, CaseTypeStateReport, CaseTypeStateReportRecord, CaseTypeStateReportStateInfo, CaseTypeStatesList, CaseTypeStatesListList, CaseTypesList, CaseTypesReport, ClaimsResolver, DEFAULT_COLORS, DEFAULT_STATE_COLOR, DEFAULT_TYPE_COLOR, DocTags, Document, DocumentAction, DocumentList, GENERIC_CASETYPE_ICON_SVG, GENERIC_STATE_ICON_SVG, Group, Groups, GroupsResolver, IconMap, JsonSchema, LaConfigResolver, LaProcessSelection, LiveAppsActionsComponent, LiveAppsActiveCasesReportComponent, LiveAppsActiveCasesWidgetComponent, LiveAppsAppConfigurationWidgetComponent, LiveAppsApplicationConfigurationComponent, LiveAppsApplicationCreateButtonComponent, LiveAppsApplicationListComponent, LiveAppsApplicationsComponent, LiveAppsCaseActionComponent, LiveAppsCaseActionsComponent, LiveAppsCaseActionsListComponent, LiveAppsCaseAuditComponent, LiveAppsCaseCockpitComponent, LiveAppsCaseCreatorComponent, LiveAppsCaseCreatorWidgetComponent, LiveAppsCaseCreatorsComponent, LiveAppsCaseDataComponent, LiveAppsCaseDataDisplayComponent, LiveAppsCaseListComponent, LiveAppsCaseStateAuditComponent, LiveAppsCaseStatesComponent, LiveAppsCaseSummaryComponent, LiveAppsComponent, LiveAppsConfig, LiveAppsConfigHolder, LiveAppsConfigResolver, LiveAppsCreatorDialogComponent, LiveAppsCreatorSelectorComponent, LiveAppsCreatorsComponent, LiveAppsDocumentUploadDialogComponent, LiveAppsDocumentViewerComponent, LiveAppsDocumentViewerDialogComponent, LiveAppsDocumentsComponent, LiveAppsFavoriteCasesComponent, LiveAppsHomeCockpitComponent, LiveAppsLandingPageComponent, LiveAppsLoginComponent, LiveAppsNotesComponent, LiveAppsNotesEditorComponent, LiveAppsRecentCasesComponent, LiveAppsRoleSwitcherComponent, LiveAppsSearchWidgetComponent, LiveAppsService, LiveAppsSettingsComponent, LiveAppsSettingsRecentCasesComponent, LiveAppsSettingsRolesComponent, LiveAppsSettingsSummaryCardsComponent, LiveAppsStateIconComponent, LiveAppsStateIconUploadDialogComponent, LoginContext, Metadata, Note, NoteThread, NotesList, NotesRole, Notification, NotificationCollection, NotificationList, OrgFolder, ParseAuditMessagePipe, Process, ProcessId, PurgeResult, RoleActiveResolver, RoleGuard, Roles, RolesResolver, RouteAccessControlConfig, RouteAccessDef, TcCaseCardConfigService, TcCaseDataService, TcCaseProcessesService, TcDocumentService, TcLiveAppsConfigService, TcLiveAppsReportingService, TcLiveappsLibModule, TcRolesService, Thread, ThreadList, UserInfo, TcCaseStatesService as ɵa, TcCaseAuditService as ɵb, LiveAppsCaseSearchComponent as ɵc, LiveAppsMilestoneComponent as ɵd, LiveAppsActiveCasesForTypeReportComponent as ɵe };
//# sourceMappingURL=tibco-tcstk-tc-liveapps-lib.js.map
