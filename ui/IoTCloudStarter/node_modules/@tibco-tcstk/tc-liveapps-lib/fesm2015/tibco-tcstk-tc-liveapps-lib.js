import { Injectable, ɵɵdefineInjectable, ɵɵinject, Component, ViewChild, ViewChildren, HostListener, EventEmitter, Input, Output, Inject, ElementRef, ContentChildren, Pipe, NgModule } from '@angular/core';
import { HttpHeaders, HttpClient, HttpEventType, HttpClientModule, HTTP_INTERCEPTORS } from '@angular/common/http';
import { MatDialog, MatDialogRef, MAT_DIALOG_DATA, MatSelectionList, MatSnackBar, MatButtonModule, MatCardModule, MatCheckboxModule, MatListModule, MatFormFieldModule, MatInputModule, MatIconModule, MatSelectModule, MatOptionModule, MatDialogModule, MatMenuModule, MatTooltipModule, MatTabsModule, MatToolbarModule, MatExpansionModule, MatSnackBarModule, MatProgressSpinnerModule, MatSlideToggleModule, MatProgressBarModule, MatTableModule, MatRadioModule, MatIconRegistry } from '@angular/material';
...
import { DeserializableClass, SandboxList, Claim, SharedStateContent, TcCoreCommonFunctions, TcSharedStateService, TcComponent, SharedStateEntry, SharedStateList, TcButtonsHelperService, DurationSincePipe, TcVisibilityService, LegacyIframeService, RouteAction, TibcoCloudSettingsGeneralComponent, TibcoCloudNewElementComponent, RoleAttribute, TcGeneralConfigService, LandingPageItemConfig as LandingPageItemConfig$1, ActionButtonConfig as ActionButtonConfig$1, TcGeneralLandingPageService, UiAppIdConfig, GeneralConfigResolver, TibcoCloudUploadDialogComponent, TcGeneralLandingPageConfigService, TcCoreLibModule, RequestCacheService, CachingInterceptor } from '@tibco-tcstk/tc-core-lib';
import { Subject, Observable, of, forkJoin, throwError, zip, ReplaySubject } from 'rxjs';
...
import { distinctUntilChanged as distinctUntilChanged$1 } from 'rxjs/internal/operators/distinctUntilChanged';
 ...
 */
class FormTab extends DeserializableClass {
}
class NoteThread {
    /**
     * @param {?} threadId
...
class RouteAccessControlConfigurationElement {
    /**
     * @template THIS
     * @this {THIS}
     * @param {?} input
...
class LiveAppsComponent {
    ...
    setupWidthObserver() {
        ...
        })).pipe(distinctUntilChanged$1(), map((/**
         * @param {?} width
         * @return {?}
         */
        width => {
...
class LiveAppsCaseStatesComponent extends LiveAppsComponent {
    ...
    constructor(caseStatesService, durationSince) {
         ...
         */
        () => {
            this.caseStatesService.getTracker(this.caseRef, this.sandboxId, this.appId).pipe(take(1), takeUntil(this._destroyed$)).subscribe((/**
             * @param {?} tracker
             * @return {?}
             */
            tracker => {
 ...
 */
class LiveAppsLegacyProcessComponent extends LiveAppsComponent {
    /**
 ...
 * \@example <tcla-live-apps-legacy-form></tcla-live-apps-legacy-form>
 */
class LiveAppsLegacyFormComponent extends LiveAppsComponent {
    /**
     * @param {?} visibilityService
     * @param {?} host
     * @param {?} legacyIframeService
...
/** @nocollapse */ TcWorkitemsService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcWorkitemsService_Factory() { return new TcWorkitemsService(ɵɵinject(HttpClient)); }, token: TcWorkitemsService, providedIn: "root" });
 ...
 */
class LiveAppsWorkitemsComponent extends LiveAppsComponent {
    /**
...
class CaseCreatorSelectionContext {
     ...
     */
    constructor(application, initialData, sandboxId, customFormDefs, legacyCreators, formsFramework) {
    ...
    ngOnInit() {
        ...
        landingPage => {
            if (landingPage !== undefined) {
                ...
                this.highlights.push(new LandingPageItemConfig$1().deserialize({
                ...
                this.actionButtons.push(new ActionButtonConfig$1().deserialize({ text: 'Get started', route: landingPage.homeRoute }));
...
/** @nocollapse */ TcAccessControlService.ngInjectableDef = ɵɵdefineInjectable({ factory: function TcAccessControlService_Factory() { return new TcAccessControlService(ɵɵinject(HttpClient), ɵɵinject(Location), ɵɵinject(TcSharedStateService)); }, token: TcAccessControlService, providedIn: "root" });

/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class AccessControlConfigurationResolver {
    /**
     * @param {?} location
     * @param {?} http
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class LiveAppsSettingsAccessControlComponent {
    /**
     * @param {?} route
     * @param {?} accessControlService
     * @param {?} snackBar
 ...
 */
class LiveAppsSettingsFormsComponent extends LiveAppsComponent {
    /**
     * @param {?} route
     * @param {?} liveAppsConfigService
     * @param {?} snackBar
...
/** @nocollapse */
LiveAppsSettingsFormsComponent.ctorParameters = () => [
    { type: ActivatedRoute },
    { type: TcLiveAppsConfigService },
    { type: MatSnackBar }
];
...
class GeneralLandingPageConfig {
    /**
     * @template THIS
     * @this {THIS}
     * @param {?} input
 ...
 */
class LiveAppsSettingsLandingComponent {
    /**
     * @param {?} route
...
export { AccessControlConfigurationResolver, AccessResolver, ActionButtonConfig, AllGroupsResolver, AllRolesResolver, ApiResponseError, ApiResponseText, CardConfig, CaseAction, CaseActionsList, CaseAttribute, CaseCreator, CaseCreatorSelectionContext, CaseCreatorsList, CaseDataResolver, CaseGuard, CaseInfo, CaseInfoList, CaseInfoWithSchema, CaseList, CaseRoute, CaseSearchResults, CaseType, CaseTypeReportRecord, CaseTypeReportRecordInfo, CaseTypeState, CaseTypeStateReport, CaseTypeStateReportRecord, CaseTypeStateReportStateInfo, CaseTypeStatesList, CaseTypeStatesListList, CaseTypesList, CaseTypesReport, ClaimsResolver, DEFAULT_COLORS, DEFAULT_STATE_COLOR, DEFAULT_TYPE_COLOR, DocTags, Document, DocumentAction, DocumentList, FormTab, GENERIC_CASETYPE_ICON_SVG, GENERIC_STATE_ICON_SVG, GeneralLandingPageConfig, Group, Groups, GroupsResolver, IconMap, JsonSchema, LaConfigResolver, LaProcessSelection, LandingPageConfig, LandingPageItemConfig, LiveAppsActionsComponent, LiveAppsActiveCasesForTypeReportComponent, LiveAppsActiveCasesReportComponent, LiveAppsActiveCasesWidgetComponent, LiveAppsAppConfigurationWidgetComponent, LiveAppsApplicationConfigurationComponent, LiveAppsApplicationCreateButtonComponent, LiveAppsApplicationListComponent, LiveAppsApplicationsComponent, LiveAppsCaseActionComponent, LiveAppsCaseActionsComponent, LiveAppsCaseActionsListComponent, LiveAppsCaseAuditComponent, LiveAppsCaseCockpitComponent, LiveAppsCaseCreatorComponent, LiveAppsCaseCreatorWidgetComponent, LiveAppsCaseCreatorsComponent, LiveAppsCaseDataComponent, LiveAppsCaseDataDisplayComponent, LiveAppsCaseListComponent, LiveAppsCaseStateAuditComponent, LiveAppsCaseStatesComponent, LiveAppsCaseSummaryComponent, LiveAppsComponent, LiveAppsConfig, LiveAppsConfigHolder, LiveAppsConfigResolver, LiveAppsCreatorDialogComponent, LiveAppsCreatorSelectorComponent, LiveAppsCreatorsComponent, LiveAppsDocumentUploadDialogComponent, LiveAppsDocumentViewerComponent, LiveAppsDocumentViewerDialogComponent, LiveAppsDocumentsComponent, LiveAppsFavoriteCasesComponent, LiveAppsHomeCockpitComponent, LiveAppsLandingPageComponent, LiveAppsLegacyFormComponent, LiveAppsLegacyProcessComponent, LiveAppsLoginComponent, LiveAppsNotesComponent, LiveAppsNotesEditorComponent, LiveAppsRecentCasesComponent, LiveAppsRoleSwitcherComponent, LiveAppsSearchWidgetComponent, LiveAppsService, LiveAppsSettingsAccessControlComponent, LiveAppsSettingsComponent, LiveAppsSettingsFormsComponent, LiveAppsSettingsLandingComponent, LiveAppsSettingsRecentCasesComponent, LiveAppsSettingsRolesComponent, LiveAppsSettingsSummaryCardsComponent, LiveAppsStateIconComponent, LiveAppsStateIconUploadDialogComponent, LiveAppsWorkitemsComponent, LoginContext, Metadata, Note, NoteThread, NotesList, NotesRole, Notification, NotificationCollection, NotificationList, OrgFolder, ParseAuditMessagePipe, Process, ProcessId, PurgeResult, RoleActiveResolver, RoleGuard, Roles, RolesResolver, RouteAccessControlConfig, RouteAccessControlConfigurationElement, TcCaseCardConfigService, TcCaseDataService, TcCaseProcessesService, TcDocumentService, TcLiveAppsConfigService, TcLiveAppsReportingService, TcLiveappsLibModule, TcRolesService, TcWorkitemsService, Thread, ThreadList, UserInfo, TcCaseStatesService as ɵa, TcCaseAuditService as ɵb, LiveAppsCaseSearchComponent as ɵc, LiveAppsMilestoneComponent as ɵd, TcAccessControlService as ɵe };
