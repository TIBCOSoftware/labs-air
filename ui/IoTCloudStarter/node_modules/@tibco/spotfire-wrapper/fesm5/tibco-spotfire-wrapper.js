import { __spread, __assign, __read, __extends } from 'tslib';
import { Injectable, Inject, ɵɵdefineInjectable, ɵɵinject, Component, ViewEncapsulation, Input, ViewChild, ElementRef, Output, EventEmitter, NgModule } from '@angular/core';
...
var Data = /** @class */ (function () {
    function Data(_data) {
        ...
        function (columns) {
             ...
             * @return {?}
             */
            function (col) { return obs.push(zip.apply(void 0, __spread([of(col)], [(/**
                 * @param {?} a
                 * @param {?} b
                 * @return {?}
                 */
...
var DocumentService = /** @class */ (function () {
    function DocumentService(lazySvc) {
         ...
         */
        function (params) {
            return _this.openWebPlayer$(params).pipe(mergeMap((/**
             * @param {?} doc
             * @return {?}
             */
            function (doc) { return forkJoin([
    ...
    function (params) {
         ...
         * @return {?}
         */
        function (f) { return _this.doConsole("Spotfire " + sfLoaderUrl + " is LOADED !!!", params.domid, f, spotfire, params.page, params.customization); })), mergeMap((/**
         * @param {?} _
         * @return {?}
         */
    ...
    function (params) {
         ...
         * @return {?}
         */
        function (f) { return _this.doConsole('onApplicationReady$ is done'); })), mergeMap((/**
         * @param {?} _
         * @return {?}
         */
    ...
    function (params) {
        ...
        if (params.document) {
             ...
             * @return {?}
             */
            function (f) { return (/** @type {?} */ (params.document)); })), tap((/**
             * @param {?} f
             * @return {?}
             */
