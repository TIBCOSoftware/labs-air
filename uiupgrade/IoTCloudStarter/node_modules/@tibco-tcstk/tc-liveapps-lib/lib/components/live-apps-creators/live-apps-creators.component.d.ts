 ...
 */
export declare class LiveAppsCreatorsComponent implements OnInit {
    creatorSelector: LiveAppsCreatorSelectorComponent;
    /**
    ...
    handleSubmit: (data: ProcessId) => void;
    handleCreatorSelection: (process: LaProcessSelection) => void;
    constructor();
    ngOnInit(): void;
}
