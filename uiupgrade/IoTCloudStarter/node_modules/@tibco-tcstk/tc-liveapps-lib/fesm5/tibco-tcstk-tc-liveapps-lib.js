...
import { DeserializableClass, SandboxList, Claim, SharedStateContent, TcCoreCommonFunctions, TcSharedStateService, TcComponent, SharedStateEntry, SharedStateList, TcButtonsHelperService, DurationSincePipe, TcVisibilityService, LegacyIframeService, RouteAction, TibcoCloudNewElementComponent, RoleAttribute, TcGeneralConfigService, TibcoCloudSettingsGeneralComponent, LandingPageItemConfig as LandingPageItemConfig$1, ActionButtonConfig as ActionButtonConfig$1, TcGeneralLandingPageService, UiAppIdConfig, GeneralConfigResolver, TibcoCloudUploadDialogComponent, TcGeneralLandingPageConfigService, TcCoreLibModule, RequestCacheService, CachingInterceptor } from '@tibco-tcstk/tc-core-lib';
import { __extends, __spread, __read, __values } from 'tslib';
import { Observable, Subject, of, forkJoin, throwError, zip, ReplaySubject } from 'rxjs';
...
var LiveAppsCaseDataComponent = /** @class */ (function (_super) {
    ...
    function LiveAppsCaseDataComponent(caseDataService) {
         ...
         * *
         */
        _this.refreshEvent = new EventEmitter();
        _this.casedata$ = new ReplaySubject();
        _this.summary$ = new ReplaySubject();
        _this.metadata$ = new ReplaySubject();
        _this.schema$ = new ReplaySubject();
    ...
    function () {
        ...
        function (landingPage) {
            if (landingPage !== undefined) {
                ...
                _this.highlights.push(new LandingPageItemConfig$1().deserialize({
                ...
                _this.actionButtons.push(new ActionButtonConfig$1().deserialize({ text: 'Get started', route: landingPage.homeRoute }));
