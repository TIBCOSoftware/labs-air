...
var LiveAppsActiveCasesReportComponent = /** @class */ (function (_super) {
    ...
    function LiveAppsActiveCasesReportComponent(reportingService) {
         ...
         */
        function () {
            _this.reportingService.getCaseTypesReport(_this.sandboxId, _this.appIds, _this.uiAppId).pipe(take(1), takeUntil(_this._destroyed$))
                .subscribe((/**
             * @param {?} report
             * @return {?}
             */
