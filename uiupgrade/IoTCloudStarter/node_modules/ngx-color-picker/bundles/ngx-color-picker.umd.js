(function (global, factory) {
    ...
    (global = global || self, factory((global.zef = global.zef || {}, global.zef.ngxColorPicker = {}), global.ng.core, global.ng.common));
    ...
    var TextDirective = /** @class */ (function () {
        ...
        TextDirective.propDecorators = {
            ...
            inputChange: [{ type: core.HostListener, args: ['input', ['$event'],] }]
        };
    ...
    var ColorPickerComponent = /** @class */ (function () {
        ...
        ColorPickerComponent.propDecorators = {
            dialogElement: [{ type: core.ViewChild, args: ['dialogPopup', { static: true },] }],
            hueSlider: [{ type: core.ViewChild, args: ['hueSlider', { static: true },] }],
            alphaSlider: [{ type: core.ViewChild, args: ['alphaSlider', { static: true },] }],
            handleEsc: [{ type: core.HostListener, args: ['document:keyup.esc', ['$event'],] }],
            handleEnter: [{ type: core.HostListener, args: ['document:keyup.enter', ['$event'],] }]
        };
    ...
    var ColorPickerDirective = /** @class */ (function () {
        ...
        ColorPickerDirective.propDecorators = {
            colorPicker: [{ type: core.Input }],
            cpWidth: [{ type: core.Input }],
            cpHeight: [{ type: core.Input }],
            cpToggle: [{ type: core.Input }],
            cpDisabled: [{ type: core.Input }],
            cpIgnoredElements: [{ type: core.Input }],
            cpFallbackColor: [{ type: core.Input }],
            cpColorMode: [{ type: core.Input }],
            cpCmykEnabled: [{ type: core.Input }],
            cpOutputFormat: [{ type: core.Input }],
            cpAlphaChannel: [{ type: core.Input }],
            cpDisableInput: [{ type: core.Input }],
            cpDialogDisplay: [{ type: core.Input }],
            cpSaveClickOutside: [{ type: core.Input }],
            cpCloseClickOutside: [{ type: core.Input }],
            cpUseRootViewContainer: [{ type: core.Input }],
            cpPosition: [{ type: core.Input }],
            cpPositionOffset: [{ type: core.Input }],
            cpPositionRelativeToArrow: [{ type: core.Input }],
            cpOKButton: [{ type: core.Input }],
            cpOKButtonText: [{ type: core.Input }],
            cpOKButtonClass: [{ type: core.Input }],
            cpCancelButton: [{ type: core.Input }],
            cpCancelButtonText: [{ type: core.Input }],
            cpCancelButtonClass: [{ type: core.Input }],
            cpPresetLabel: [{ type: core.Input }],
            cpPresetColors: [{ type: core.Input }],
            cpMaxPresetColorsLength: [{ type: core.Input }],
            cpPresetEmptyMessage: [{ type: core.Input }],
            cpPresetEmptyMessageClass: [{ type: core.Input }],
            cpAddColorButton: [{ type: core.Input }],
            cpAddColorButtonText: [{ type: core.Input }],
            cpAddColorButtonClass: [{ type: core.Input }],
            cpRemoveColorButtonClass: [{ type: core.Input }],
            cpInputChange: [{ type: core.Output }],
            cpToggleChange: [{ type: core.Output }],
            cpSliderChange: [{ type: core.Output }],
            cpSliderDragEnd: [{ type: core.Output }],
            cpSliderDragStart: [{ type: core.Output }],
            colorPickerOpen: [{ type: core.Output }],
            colorPickerClose: [{ type: core.Output }],
            colorPickerCancel: [{ type: core.Output }],
            colorPickerSelect: [{ type: core.Output }],
            colorPickerChange: [{ type: core.Output }],
            cpCmykColorChange: [{ type: core.Output }],
            cpPresetColorsChange: [{ type: core.Output }],
            handleClick: [{ type: core.HostListener, args: ['click',] }],
            handleFocus: [{ type: core.HostListener, args: ['focus',] }],
            handleInput: [{ type: core.HostListener, args: ['input', ['$event'],] }]
        };
