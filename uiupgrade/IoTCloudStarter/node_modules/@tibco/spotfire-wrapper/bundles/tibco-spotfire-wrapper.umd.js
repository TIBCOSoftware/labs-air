(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@angular/forms'), require('@angular/material/button'), require('@angular/material/checkbox'), require('@angular/material/form-field'), require('@angular/material/input'), require('@angular/material/select'), require('@angular/material/toolbar'), require('@angular/flex-layout')) :
    typeof define === 'function' && define.amd ? define('@tibco/spotfire-wrapper', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/common', '@angular/forms', '@angular/material/button', '@angular/material/checkbox', '@angular/material/form-field', '@angular/material/input', '@angular/material/select', '@angular/material/toolbar', '@angular/flex-layout'], factory) :
    (global = global || self, factory((global.tibco = global.tibco || {}, global.tibco['spotfire-wrapper'] = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.ng.common, global.ng.forms, global.ng.material.button, global.ng.material.checkbox, global.ng.material['form-field'], global.ng.material.input, global.ng.material.select, global.ng.material.toolbar, global.ng['flex-layout']));
}(this, function (exports, core, rxjs, operators, common, forms, button, checkbox, formField, input, select, toolbar, flexLayout) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var SpotfireCustomization = /** @class */ (function () {
        function SpotfireCustomization(vars) {
            var _this = this;
        ...
        return SpotfireCustomization;
    }());
    var SpotfireFilter = /** @class */ (function () {
        function SpotfireFilter(vars) {
            var _this = this;
            if (vars) {
                Object.keys(vars).forEach((/**
                 * @param {?} key
    ...
    var Data = /** @class */ (function () {
        function Data(_data) {
             ...
             * @return {?}
             */
            function (f) { return _this.getDataColumns$(f); })), operators.map((/**
             * @param {?} d
             * @return {?}
             */
            function (d) {
             ...
             * @return {?}
             */
            function (t) { return doCall(t, 'getDataColumns').pipe(operators.mergeMap((/**
             * @param {?} columns
             * @return {?}
             */
            function (columns) {
                 ...
                 * @return {?}
                 */
                function (col) { return obs.push(rxjs.zip.apply(void 0, __spread([rxjs.of(col)], [(/**
                     * @param {?} a
                     * @param {?} b
                     * @return {?}
                     */
             ...
             * @return {?}
             */
            function (t) { return doCall(t, 'getDistinctValues', 0, 20).pipe(operators.tap((/**
             * @param {?} g
             * @return {?}
             */
            ...
            operators.pluck('values')); });
            this.getTables$ = (/**
             * @return {?}
             */
            function () { return _this.getDataTables$().pipe(operators.mergeMap((/**
             * @param {?} tables
             * @return {?}
             */
            function (tables) {
            ...
            function (k) {
                 ...
                 * @return {?}
                 */
                function (p) { return z = __assign({}, z, p); }));
                return z;
            }))); });
            this.getAllTables$ = (/**
             * @return {?}
    ...
    var Document = /** @class */ (function () {
        function Document(app, id, page, custo) {
             ...
             * @return {?}
             */
            function () { return _this.do('getDocumentMetadata').pipe(operators.map((/**
             * @param {?} g
             * @return {?}
             */
             ...
             * @return {?}
             */
            function () { return _this.do('getPages').pipe(operators.map((/**
             * @param {?} m
             * @return {?}
             */
    ...
    function doCall(obj, m) {
        ...
        function (observer) {
            ...
            try {
                ...
                return m.startsWith('on') && oneShot.indexOf(m) === -1 ? obj[m].apply(obj, __spread(a, [q])) : obj[m].apply(obj, __spread(a, [p]));
            }
            catch (err) {
                console.warn('[OBS]', 'doCall erreur: ', err);
                observer.error(err);
            }
        })).pipe(operators.timeout(3001000), operators.catchError((/**
         * @param {?} e
         * @return {?}
         */
        function (e) {
    ...
    var Application = /** @class */ (function () {
        function Application(url, customization, path, parameters, reloadAnalysisInstance, version, onCreateLoginElement) {
            ...
            this.onApplicationReady$ = this.readySubject.asObservable().pipe(operators.filter((/**
             * @param {?} d
             * @return {?}
             */
            function (d) { return d; })));
    ...
    var LazyLoadingLibraryService = /** @class */ (function () {
        ...
        function (url) {
            ...
            this.loadedLibraries[url] = new rxjs.ReplaySubject();
            /** @type {?} */
        ...
        /** @nocollapse */ LazyLoadingLibraryService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function LazyLoadingLibraryService_Factory() { return new LazyLoadingLibraryService(core.ɵɵinject(common.DOCUMENT)); }, token: LazyLoadingLibraryService, providedIn: "root" });
    ...
    var DocumentService = /** @class */ (function () {
        function DocumentService(lazySvc) {
            var _this = this;
            ...
            function () {
                ...
                return console.log.apply(console, __spread(['[DOCUMENT-SERVICE]'], args));
            });
            // %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            //
            this.getMetadata$ = (/**
             ...
             */
            function (params) {
                return _this.openWebPlayer$(params).pipe(operators.mergeMap((/**
                 * @param {?} doc
                 * @return {?}
                 */
                function (doc) { return rxjs.forkJoin([
                 ...
                 */
                function (_a) {
                    var _b = __read(_a, 3), metadata = _b[0], tables = _b[1], markings = _b[2];
                    return ({ metadata: metadata, tables: tables, markings: markings });
                })));
            });
            /**
             * \@description
             ...
             */
            function () {
                _this.doConsole('Creating the login element');
         ...
         * @return {?}
         */
        DocumentService.prototype.openWebPlayer$ = 
        // %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        //
        /**
         * @param {?} params
        ...
        function (params) {
            ...
            //
            /** @type {?} */
            var sfLoaderUrl = params.url + "/spotfire/js-api/loader.js";
            return this.lazySvc.loadJs(sfLoaderUrl).pipe(operators.delay(1000), operators.tap((/**
             * @param {?} f
             * @return {?}
             */
            function (f) { return _this.doConsole("Spotfire " + sfLoaderUrl + " is LOADED !!!", params.domid, f, spotfire, params.page, params.customization); })), operators.mergeMap((/**
             * @param {?} _
             * @return {?}
             */
            function (_) { return _this.openPath$(params); })));
        };
        // %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        //
        // %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
         ...
         * @return {?}
         */
        DocumentService.prototype.openPath$ = 
        // %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        //
        /**
         * @param {?} params
        ...
        function (params) {
             ...
             */
            return params.app.onApplicationReady$.pipe(operators.tap((/**
             * @param {?} f
             * @return {?}
             */
            function (f) { return _this.doConsole('onApplicationReady$ is done'); })), operators.mergeMap((/**
             * @param {?} _
             * @return {?}
             */
            function (_) { return _this.openPage$(params); })));
        };
        // %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        //
        // %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
         ...
         * @return {?}
         */
        DocumentService.prototype.openPage$ = 
        // %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        //
        /**
         * @param {?} params
        ...
        function (params) {
            ...
            if (params.document) {
                ...
                return params.document.onDocumentReady$().pipe(operators.map((/**
                 * @param {?} f
                 * @return {?}
                 */
                function (f) { return (/** @type {?} */ (params.document)); })), operators.tap((/**
                 * @param {?} f
                 * @return {?}
                 */
                function (f) { return _this.doConsole('onDocumentReady$ is done', f); })));
            }
        };
        ...
        /** @nocollapse */ DocumentService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function DocumentService_Factory() { return new DocumentService(core.ɵɵinject(LazyLoadingLibraryService)); }, token: DocumentService, providedIn: "root" });
    ...
    var SpotfireViewerComponent = /** @class */ (function () {
        function SpotfireViewerComponent(docSvc) {
            ...
            function () {
                ...
                return _this.debug && console.log.apply(console, __spread(['[SPOTFIRE-VIEWER]'], args));
            });
            this.ngOnChanges = (/**
             * @param {?} changes
             * @return {?}
            ...
            function (doc) {
                ...
                if (_this.isFiltingWiredUp()) {
                    ...
                    //
                    _this.filter$.pipe(operators.tap((/**
                     * @param {?} f
                     * @return {?}
                     */
                ...
                if (_this.isMarkingWiredUp()) {
                    ...
                    //
                    _this.marker$.pipe(operators.tap((/**
                     * @param {?} f
                     * @return {?}
                     */
        ...
        function (url, path, customization) {
            ...
            this.spotParams = __assign({}, this.spotParams, { path: path, url: url, customization: customization, domid: this.spot.nativeElement.id, page: this.page });
        ...
        function (path) {
            ...
            this.spotParams = __assign({}, this.spotParams, { path: path, domid: this.spot.nativeElement.id });
        ...
        function (page) {
            ...
            this.page = page;
            this.spotParams = __assign({}, this.spotParams, { page: page });
            /** @type {?} */
        ...
        SpotfireViewerComponent.propDecorators = {
            ...
            sid: [{ type: core.Input }],
            customization: [{ type: core.Input }],
            filters: [{ type: core.Input }],
            markingOn: [{ type: core.Input }],
            maxRows: [{ type: core.Input }],
            parameters: [{ type: core.Input }],
            spot: [{ type: core.ViewChild, args: ['spot', { static: true, read: core.ElementRef },] }],
            filteringEvent: [{ type: core.Output }],
            markingEvent: [{ type: core.Output }]
        };
    ...
    var PersistanceService = /** @class */ (function () {
        ...
        /** @nocollapse */ PersistanceService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function PersistanceService_Factory() { return new PersistanceService(); }, token: PersistanceService, providedIn: "root" });
    ...
    var SpotfireEditorComponent = /** @class */ (function (_super) {
        __extends(SpotfireEditorComponent, _super);
        ...
        function (doc) {
            ...
            this.form = this.fb.group({
                url: [this.url, forms.Validators.required],
                path: [this.path, forms.Validators.required],
            ...
            function (__) {
                ...
                function (tables) {
                    ...
                    function (tname) {
                        ...
                        mar.addControl(tname, new forms.FormControl(_this.markingOn ? _this.markingOn[tname] : null));
                        if (!fil.contains(tname)) {
                            fil.addControl(tname, new forms.FormGroup({}));
                        }
                        /** @type {?} */
                        ...
                        */
                        ...
                        function (cname) {
                            ...
                            frm.addControl(cname, new forms.FormControl(flt2 ? flt2.filterSettings.values : null));
                        }));
                    }));
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var SpotfireViewerModule = /** @class */ (function () {
        function SpotfireViewerModule() {
        }
        SpotfireViewerModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        exports: [SpotfireViewerComponent, common.CommonModule]
                    },] }
        ];
        return SpotfireViewerModule;
    }());
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var SpotfireEditorModule = /** @class */ (function () {
        function SpotfireEditorModule() {
        }
        SpotfireEditorModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [SpotfireViewerModule, forms.ReactiveFormsModule, flexLayout.FlexLayoutModule,
                            select.MatSelectModule, toolbar.MatToolbarModule, checkbox.MatCheckboxModule,
                            button.MatButtonModule, formField.MatFormFieldModule, input.MatInputModule],
                        declarations: [SpotfireEditorComponent],
                        entryComponents: [SpotfireEditorComponent],
                        exports: [SpotfireEditorComponent]
                    },] }
        ];
        return SpotfireEditorModule;
    }());

    exports.DocumentService = DocumentService;
    exports.SpotfireCustomization = SpotfireCustomization;
    exports.SpotfireEditorComponent = SpotfireEditorComponent;
    exports.SpotfireEditorModule = SpotfireEditorModule;
    exports.SpotfireParameters = SpotfireParameters;
    exports.SpotfireViewerComponent = SpotfireViewerComponent;
    exports.SpotfireViewerModule = SpotfireViewerModule;
    exports.ɵa = LazyLoadingLibraryService;
    exports.ɵb = PersistanceService;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=tibco-spotfire-wrapper.umd.js.map
